        ...
        <div class="col-lg-6 col-md-6">
          ...
          <div class="col-lg-6 col-md-6">
            <ul id="listprant">
              ...
              <hr />
              <li>
                <span><h4>الحلقات</h4></span>
                <h5>
                  {{ this.move.number_of_episodes }}
                </h5>
              </li>
              <hr />
              <li>
                <span><h4>الموسم</h4></span>
                <h5>{{ this.move.number_of_seasons }}</h5>
              </li>
              <hr />
              <li>
...
export default {
  ...
  computed: {
    ...mapState(mystore, ["singelTV", "trial"]),
  },
  methods: {
    ld() {
      window.scroll(0, 0);
